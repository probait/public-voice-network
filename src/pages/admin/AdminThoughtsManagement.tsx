...
const AdminThoughtsManagement = () => {
  ...
  const filteredThoughts = thoughts.filter(thought =>
    thought.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
    thought.thought.toLowerCase().includes(searchTerm.toLowerCase()) ||
    thought.email.toLowerCase().includes(searchTerm.toLowerCase())
  );
            ...
            {filteredThoughts.length === 0 && (
              <div className="text-center py-8">
                <p className="text-gray-500">
                  {searchTerm ? 'No thoughts found matching your search.' : 'No thoughts submitted yet.'}
                </p>
              </div>
            )}
          </CardContent>
