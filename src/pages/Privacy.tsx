              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-6 text-muted-foreground">
                  <div>
                    ...
                    <p>When you submit a concern, we collect:</p>
                    <ul className="list-disc list-inside mt-2 space-y-1">
                      <li>Your name and email address</li>
                      <li>Your location (city, state/province, country)</li>
                      <li>The content of your concern or issue</li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1">
                      <li>Display your concern in our public community feed (with your chosen anonymity settings)</li>
                      <li>Provide aggregated, anonymized data to policymakers, nonprofits, and commercial AI firms</li>
                      <li>Analyze trends and patterns in community concerns</li>
                      <li>Contact you about your submission (only if necessary)</li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside mt-2 space-y-1">
                      ...
                      <li>Nonprofit organizations working on community issues</li>
                      <li>Commercial AI firms for training and research purposes</li>
                      <li>Academic researchers studying social issues</li>
                    </ul>
              ...
              <CardContent className="p-8">
                ...
                <div className="space-y-6 text-muted-foreground">
                  <div>
                    ...
                    <p>By using Community Voices, you agree to:</p>
                    <ul className="list-disc list-inside mt-2 space-y-1">
                      <li>Provide truthful and accurate information</li>
                      <li>Respect the privacy and rights of others</li>
                      <li>Not submit harmful, offensive, or illegal content</li>
                      <li>Not spam or abuse the platform</li>
                      <li>Use the platform for its intended purpose of sharing legitimate community concerns</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside mt-2 space-y-1">
                      <li>Relevant to community issues or concerns</li>
                  ...
                  <div>
                    ...
                    <p>Community Voices is provided "as is" without warranties. We are not responsible for the accuracy of user-submitted content or any decisions made based on platform data.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <div className="mt-4 space-y-1 text-muted-foreground">
                  <p><strong>Email:</strong> <a href="mailto:privacy@communityvoices.org" className="text-primary hover:underline">privacy@communityvoices.org</a></p>
                  <p><strong>General inquiries:</strong> <a href="mailto:contact@communityvoices.org" className="text-primary hover:underline">contact@communityvoices.org</a></p>
                </div>
              </CardContent>
            </Card>
          </div>
