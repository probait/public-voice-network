...
const Auth = () => {
  ...
  const { signInWithEmail, signUpWithEmail, signInWithMagicLink, signInWithGoogle, resetPassword } = useAuth();
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold text-red-600">Join PolicyNow</CardTitle>
          <CardDescription>
            Sign in to start your campaign for change
          </CardDescription>
        </CardHeader>
        <CardContent>
